...
export default async function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-[#F5F5F0]">
      {/* Hero Section */}
      <section className="relative h-screen overflow-hidden bg-[#F5F5F0]">
        {/* Decorative leaves */}
        ...
        <div className="h-full grid lg:grid-cols-2 relative z-10">
          {/* Text Content - Left Side */}
          <div className="flex items-center justify-center bg-[#F5F5F0] px-8 sm:px-12 lg:px-16">
            <div className="text-center lg:text-left space-y-8 max-w-2xl">
              <h1 className="font-serif text-4xl sm:text-5xl lg:text-6xl font-medium text-[#1B3B5F] leading-tight">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <AuthModal mode="signup">
                  <Button
                    size="lg"
                    className="bg-[#1B3B5F] hover:bg-[#16304d] text-white text-lg px-10 py-6 h-auto rounded-full shadow-lg transition-all hover:scale-105"
                  >
                ...
                <Link href="/features">
                  <Button
                    variant="outline"
                    size="lg"
                    className="border-2 border-[#1B3B5F] text-[#1B3B5F] hover:bg-[#1B3B5F] hover:text-white text-lg px-10 py-6 h-auto rounded-full transition-all"
                  >
                    Learn More
                  </Button>
                </Link>
      ...
      <section className="py-24 bg-gradient-to-b from-[#F5F5F0] to-white">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-12">
            {/* Share Stories */}
            <div className="text-center space-y-6 group p-6 rounded-2xl hover:bg-white hover:shadow-xl transition-all duration-300">
              <div className="flex justify-center">
                <div className="w-24 h-24 rounded-full bg-[#E8F0F5] group-hover:bg-[#1B3B5F]/10 flex items-center justify-center transition-colors duration-300">
                  <Flame className="w-12 h-12 text-[#4A90A4] group-hover:text-[#1B3B5F] transition-colors duration-300" />
                </div>
              </div>
              <div className="space-y-3">
                <h3 className="text-2xl font-serif font-medium text-[#1B3B5F]">Share Stories</h3>
            ...
            <div className="text-center space-y-6 group p-6 rounded-2xl hover:bg-white hover:shadow-xl transition-all duration-300">
              <div className="flex justify-center">
                <div className="w-24 h-24 rounded-full bg-[#E8F0F5] group-hover:bg-[#1B3B5F]/10 flex items-center justify-center transition-colors duration-300">
                  <ImageIcon className="w-12 h-12 text-[#4A90A4] group-hover:text-[#1B3B5F] transition-colors duration-300" />
                </div>
              </div>
              <div className="space-y-3">
                <h3 className="text-2xl font-serif font-medium text-[#1B3B5F]">Upload Photos & Videos</h3>
                <p className="text-lg text-slate-600 leading-relaxed">
            ...
            <div className="text-center space-y-6 group p-6 rounded-2xl hover:bg-white hover:shadow-xl transition-all duration-300">
              <div className="flex justify-center">
                <div className="w-24 h-24 rounded-full bg-[#E8F0F5] group-hover:bg-[#1B3B5F]/10 flex items-center justify-center transition-colors duration-300">
                  <Users className="w-12 h-12 text-[#4A90A4] group-hover:text-[#1B3B5F] transition-colors duration-300" />
                </div>
              </div>
              <div className="space-y-3">
                <h3 className="text-2xl font-serif font-medium text-[#1B3B5F]">Invite Family & Friends</h3>
                <p className="text-lg text-slate-600 leading-relaxed">
      ...
      <section className="py-24 bg-white relative overflow-hidden">
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 relative z-10">
          <p className="text-2xl lg:text-3xl font-serif text-[#1B3B5F] leading-relaxed text-center">
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div className="space-y-10">
              <div className="flex items-start gap-6 group">
                <div className="w-16 h-16 rounded-2xl bg-white shadow-md flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-300">
                  <Flame className="w-8 h-8 text-[#4A90A4]" />
                </div>
                <div>
                  <h4 className="text-xl font-serif font-medium text-[#1B3B5F] mb-2">A Place for Stories</h4>
                  <p className="text-lg text-slate-600 leading-relaxed">
              ...
              <div className="flex items-start gap-6 group">
                <div className="w-16 h-16 rounded-2xl bg-white shadow-md flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-300">
                  <ImageIcon className="w-8 h-8 text-[#4A90A4]" />
                </div>
                <div>
                  <h4 className="text-xl font-serif font-medium text-[#1B3B5F] mb-2">Visual Memories</h4>
                  <p className="text-lg text-slate-600 leading-relaxed">
              ...
              <div className="flex items-start gap-6 group">
                ...
                <div>
                  <h4 className="text-xl font-serif font-medium text-[#1B3B5F] mb-2">Private & Secure</h4>
                  <p className="text-lg text-slate-600 leading-relaxed">
            ...
            <div className="bg-white rounded-3xl shadow-xl p-10 md:p-12 space-y-6 border border-slate-100">
              <h3 className="text-3xl font-serif font-medium text-[#1B3B5F] mb-4">Built for Calm Remembrance</h3>
              <p className="text-lg text-slate-600 leading-relaxed">
              ...
              <div className="pt-6">
                <AuthModal mode="signup">
                  <Button className="bg-[#1B3B5F] hover:bg-[#16304d] text-white text-lg px-8 py-6 h-auto rounded-full shadow-md w-full sm:w-auto">
                    Start Creating Now
                  </Button>
                </AuthModal>
              </div>
      ...
      {/* Testimonial Section */}
      <section className="py-24 bg-[#E8F5E8]/50 relative overflow-hidden">
        {/* Decorative leaf branch */}
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="flex justify-center mb-10">
            <div className="w-20 h-20 rounded-full bg-white flex items-center justify-center shadow-sm">
              <Quote className="w-10 h-10 text-[#4A90A4]" />
            </div>
          </div>
          <blockquote className="text-2xl lg:text-4xl font-serif font-medium text-[#1B3B5F] text-center leading-tight mb-12">
          ...
          <div className="flex items-center justify-center gap-5">
            <div className="w-16 h-16 rounded-full bg-[#1B3B5F] text-white flex items-center justify-center text-xl font-semibold shadow-lg border-4 border-white">
              OR
            </div>
            <div className="text-left">
              <p className="text-xl font-semibold text-[#1B3B5F]">Ovania Reithoane</p>
              <p className="text-lg text-slate-600">Family Member</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Memorial search */}
      <section className="py-24 bg-white" id="memorial-search">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-[0.95fr,1.05fr] gap-12 items-start">
            <div className="space-y-6">
              <p className="text-sm font-semibold uppercase tracking-[0.15em] text-[#4A90A4]">Find someone</p>
              <h2 className="text-4xl lg:text-5xl font-serif font-medium text-[#1B3B5F]">
              ...
              <ul className="space-y-3 text-slate-700">
                <li className="flex gap-3">
                  <span className="mt-1 h-2 w-2 rounded-full bg-[#1B3B5F]" aria-hidden />
                  <span>Works from any page — just search and jump to the right memorial.</span>
                </li>
                <li className="flex gap-3">
                  <span className="mt-1 h-2 w-2 rounded-full bg-[#1B3B5F]" aria-hidden />
                  <span>Quick filters for names, titles, and places with a single request.</span>
                </li>
                <li className="flex gap-3">
                  <span className="mt-1 h-2 w-2 rounded-full bg-[#1B3B5F]" aria-hidden />
                  <span>No distracting motion — clear results that load swiftly.</span>
                </li>
              </ul>
            </div>
            <MemorialSearch
      ...
      <section className="py-24 bg-[#F5F5F0]">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl lg:text-5xl font-serif font-medium text-[#1B3B5F] mb-8">
          ...
          <AuthModal mode="signup">
            <Button 
              size="lg" 
              className="bg-[#1B3B5F] hover:bg-[#16304d] text-white text-xl px-12 py-8 h-auto rounded-full shadow-xl hover:shadow-2xl transition-all hover:scale-105"
            >
              Start a Free Memorial
            </Button>
          </AuthModal>
